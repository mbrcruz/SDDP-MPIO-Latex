...
\begin{figure}[ht]
\centering
\includegraphics[width=.62\textwidth]{figuras/SDDP_architecture}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{figuras/SDDP_architecture2}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{figuras/SDDP_timeline_MPIIO}
...
\centering
\includegraphics[width=\textwidth]{figuras/Banda_AWS}
\caption{Banda agregada percebida.}
\label{fig:banda_aws}
\end{subfigure}\hfill
\begin{subfigure}[b]{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{figuras/Tempo_execucao_AWS}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.62\textwidth]{figuras/Experimento_OSTs_banda}
...
\begin{subfigure}[b]{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{figuras/Banda_SDumont}
\caption{Banda agregada percebida.}
\label{fig:banda_sdumont}
\end{subfigure}\hfill
\begin{subfigure}[b]{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{figuras/Tempo_execucao_SDumont}
