...
escrita ao filesystem. Essa abordagem é adotada neste trabalho nos arquivos
no formato horário, nos quais os registros de um mesmo par
$(\text{estágio}, \text{cenário})$ são acumulados e gravados em uma única
operação agregada.
