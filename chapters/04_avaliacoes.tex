...
É importante destacar que a fração relativa da \texttt{MPI\_File\_open}/\texttt{MPI\_File\_close}
...
--- diluindo a fração relativa da \texttt{MPI\_File\_open}/\texttt{MPI\_File\_close} para níveis
