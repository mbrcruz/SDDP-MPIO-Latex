...
incluindo tempos de I/O, comunicação, tempo total, \textit{speedup} e percentual de I/O. O total corresponde ao tempo de simulação mais comunicação.}
...
mensagens no Experimento AWS, em escala logarítmica. A comparação mostra
que, para mensagens muito pequenas, a implementação atual apresenta
...
Para mensagens médias e grandes, que concentram o impacto de E/S nas
...
mensagens, enquanto a implementação MPI-IO permanece na ordem de
...
para mensagens muito pequenas, mas perde escalabilidade quando o volume
...
por classe de tamanho das mensagens. Em 16~nós, a configuração com
