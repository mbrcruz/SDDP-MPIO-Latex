...
\begin{document}
  ...
  investiga os gargalos de E/S da fase de simulação final do algoritmo SDDP e propõe uma arquitetura MPI-IO baseada em MPI-IO sobre Lustre, avaliada empiricamente nos
