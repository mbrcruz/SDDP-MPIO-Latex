...
cenários avaliados. Observa-se que a distribuição é dominada por blocos de
dados pequenos: 1.173 blocos, correspondentes a 80,1\% do total, possuem
tamanho de até 1~KB. As demais faixas concentram 99 blocos até 128~KB
(6,8\%), 174 blocos até 1~MB (11,9\%) e 18 blocos até 50~MB (1,2\%).
...
\begin{figure}[hbt]
  ...
  \caption{Distribuição da quantidade de blocos de dados por faixa de
  tamanho, em escala logarítmica.}
