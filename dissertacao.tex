...
Em 2~nós, a banda agregada da implementação atual é cerca de 70\% maior
...
$4{,}5\times$ maior; em 16~nós, cerca de $54\times$ maior; e, em
32~nós, aproximadamente $118\times$ maior. Esse resultado indica que a
...
em 32~nós. Parte do tempo total da implementação MPI-IO passa a ser
ocupada pelas operações coletivas de abertura e fechamento de arquivos,
que chegam a 12,1\% em 16~nós e 24,2\% em 32~nós. Embora essas
operações introduzam sincronização global, seu custo é menor que a
contenção imposta pelo escritor único, e a implementação MPI-IO apresenta
tempo total inferior ao da implementação atual em todas as escalas
avaliadas.
