...
\texttt{MPI\_File\_Open}/\texttt{MPI\_File\_Close}. As parcelas de E/S e
de Coordenação MPI-IO estão embutidas no tempo de simulação e não devem
ser somadas novamente ao total. Em 2~nós, a implementação MPI-IO
...
\begin{figure}[hbt]
  ...
  atual e MPI-IO no Experimento SDumont; Coordenação MPI-IO =
...
\begin{figure}[hbt]
  ...
  \caption{Tempo de execução no Experimento AWS; Coordenação MPI-IO =
  \texttt{MPI\_File\_Open}/\texttt{MPI\_File\_Close}.}
