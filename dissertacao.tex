...
os resultados via \texttt{MPI\_Send}/\texttt{MPI\_Recv}. Em relação ao
Experimento AWS, este experimento apresenta maior grau de concorrência
agregada por causa do número de nós e dos recursos disponíveis em cada
um deles, o que intensifica a contenção sobre o processo escritor
único. A Tabela~\ref{tab:central_sdumont} sumariza os resultados,
considerando 1.536 cenários, três estágios mensais e
24 \textit{ranks} por nó.
